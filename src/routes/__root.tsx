  ...
  head: () => ({
    meta: [
      ...
      { title: "AiXin — The trust layer for agentic AI" },
      {
        name: "description",
        content:
          "Hatch one Master Twin and govern a team of specialists. Signal Intent Protocol, Decision Cards, signed receipts on BSC.",
      },
      { name: "author", content: "AiXin" },
      { property: "og:title", content: "AiXin — The trust layer for agentic AI" },
      {
        property: "og:description",
        content:
          "Hatch one Master Twin and govern a team of specialists. Every action is schema-checked, human-approved, receipt-anchored.",
      },
